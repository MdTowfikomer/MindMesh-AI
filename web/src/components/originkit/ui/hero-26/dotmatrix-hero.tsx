...
export function DotmatrixHero({
  ...
  primaryCtaLabel = "Download Android APK",
  primaryCtaHref = "https://github.com/MdTowfikomer/MindMesh-AI/releases/latest/download/app-release.apk",
  secondaryCtaLabel = "Explore Live Demo",
  secondaryCtaHref = "#features",
  aboutLabel = "Features",
  aboutHref = "#features",
  docsLabel = "Knowledge Mesh",
  docsHref = "#memory-stream",
  joinLabel = "Get APK",
    ...
    <section className="ok-h26-hero">
      <nav className="ok-h26-nav">
        <a href="#" className="flex items-center gap-3 text-white no-underline group">
          <div className="relative w-8 h-8 rounded-xl overflow-hidden border border-white/20 shadow-md flex items-center justify-center bg-black/60 group-hover:scale-105 transition-transform">
            <img
              src={logoSrc}
              alt={brandName}
              className="w-full h-full object-cover"
              onError={(e) => {
                (e.currentTarget as HTMLImageElement).src = asset("logomark.svg");
              }}
            />
          </div>
          <span className="font-sans font-semibold tracking-tight text-base text-white/95 group-hover:text-white transition-colors">
            {brandName}
          </span>
        </a>
        <div className="ok-h26-nav-links">
          <a className="ok-h26-nav-pill" href={aboutHref}>
            {aboutLabel}
          </a>
        ...
        <div className="ok-h26-hero-inner">
          <div className="ok-h26-hero-content">
            ...
            <div className="ok-h26-cta-row">
              <a className="ok-h26-btn ok-h26-btn--white" href={primaryCtaHref} target="_blank" rel="noopener noreferrer">
